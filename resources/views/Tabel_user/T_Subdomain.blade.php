      ...
      <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-lg-8">
            ...
            <h1 class="fg-white text-center">Monitor Aplikasi Resmi di Luar Server Kominfo</h1>
          </div>
        </div>
      </div>
    </div> 
  ...
  <div class="row ">
    <div class="col-lg-12 mx-auto">
      ...
      @foreach($items as $item)
              ...
              <br>
                <li class="breadcrumb-item"><a href="{{route('cetak_DataSubdomain')}}" target="_blank">Download PDF</a></li>
